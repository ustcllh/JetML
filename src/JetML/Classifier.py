...
class Classifier:
    def __init__(self, model_dict, input_size=4, output_size=2, num_layers=6):
    ...
    def load_lstm(self, model_dict):
        model = LSTM(input_size=self.input_size, output_size=self.output_size, num_layers=self.num_layers)
