...
int comp_first_zcut0p5_beta1p5(){
  gStyle->SetOptStat(0);
  double zcut = 0.5;
  double beta = 1.5;
  double ptmin = 80;
  ...
  Tl.DrawLatex(0.04,6.5, "First Soft Drop");
  ...
  c1->SaveAs("../plot/z_first_zcut0p5_beta1p5.pdf");
  ...
  TH1F* frame21 = DrawFrame(0., 0.42, 2e-2, 5e3, title2, false);
  ...
  Tl.DrawLatex(0.04,1e2, "First Soft Drop");
  ...
  c2->SaveAs("../plot/delta_first_zcut0p5_beta1p5.pdf");
