...
int comp_all_zcut0p1_beta0(){
  ...
  Tl.DrawLatex(0.04,8,"Soft Drop z_{cut}=0.1, #beta=0.");
  ...
  c1->SaveAs("../plot/z_all_zcut0p1_beta0.pdf");
  ...
  TH1F* frame21 = DrawFrame(0., 0.42, 4e-2, 5e3, title2, false);
  ...
  Tl.DrawLatex(0.04,3e2,"Soft Drop z_{cut}=0.1, #beta=0.");
  ...
  c2->SaveAs("../plot/delta_all_zcut0p1_beta0.pdf");
